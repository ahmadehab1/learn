...
namespace MalalimAdmin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,Name,Price,Image1,Image2,Image3,Image4,IsFeatured,CreatedBy,CreatedOn,ExpiryDate,TotalCoupons,RemainingCoupons,MaxCouponsPerOrder,WinnerCouponId")] Product product)
        {
            if (ModelState.IsValid)
            {
